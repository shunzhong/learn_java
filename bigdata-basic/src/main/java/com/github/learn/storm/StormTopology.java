...
public class StormTopology {
	...
	public static void main(String[] args) {
		...
		topologyBuilder.setSpout("a", new MySpout(),2);//提高线程数量("a", new MySpout(),2)
		//指定让mybolt接收myspout的输出，通过shuffergrouping
		topologyBuilder.setBolt("b", new MyBolt()).setNumTasks(2).shuffleGrouping("a");
