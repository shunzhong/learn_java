...
/**
 * Created by zenith on 2015/12/28.
 */
public class KafkaStat {
...

    {
        ...
        //init path
        path.put(0,"/crxy/logout");
        path.put(1,"/crxy/getbyid");
        path.put(2,"/crxy/getlist");
        path.put(3,"/crxy/init");
        path.put(4,"/crxy/add/user");
            ...
            public void run() {
                synchronized (pathMap) {
                    ...
                    for (String key:pathMap.keySet()){
                        System.out.println(String.format("����path:%s,�Ĵ���:%s",key,pathMap.get(key)));
                    }
                    System.out.println("�ܷ��ʴ���"+times);
                    pathMap.clear();
                    times=0;
                }
